...
\[ L = L(\alpha_1 u_1 + \alpha_2 u_2) = \alpha_1 Lu_1 + \alpha_2 Lu_2 \]

ki $\alpha_1,\alpha_2$ birer tekil sayidir (scalar), ya reel, ya da
kompleks. 
...
seklinde yazabiliriz ki $L$ soyle tanimli olacaktir
...
Yani, $L$ bir vektor uzayini bir digerine eslemekte (map), ve yine diyelim
