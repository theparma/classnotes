...
p$, ve $P(X = 0) = 1 - p$ olacaktir, ki $p \in [0,1]$ olmak uzere. O zaman
...
z-skoruna bakmanin bir diger yolu o degerin ``kac standart sapma uzakta''
oldugunu gosterilmesidir. Yani olcumuz standart sapma, ve bu deger sola ya
da saga cekildikce ona tekabul eden alan (ustte sari renkle gosterilen
kisim), yani olasilik azalip cogaliyor. Grafikte mesela ``1.13 standart
sapma'' yani z-skor nereyi gosteriyor deyince, gorulen sekil / olasilik
ortaya cikiyor. Tabii dagilim standart dagilim ve standart sapma 1 oldugu
icin ``kac standart sapma'' ile z-skor arasinda direk bir baglanti var. 
...
Rasgele degiskenlerin matematiksel formullerde kullanilmasi $Z = X + Y=$
seklinde olabilir mesela. O zaman elde edilen yeni degisken de bir rasgele
degisken olur. Bu tur formuller envai sekilde olabilir, hatta rasgele
...
Iki kavramdan bahsetmek bu noktada faydali olabilir. 1) Nufus (Population)
2) Orneklem (Sample). Nufus, uzerinde istatistiksel analiz yaptigimiz
kitlenin tamami. Eger insanlarin boylari hakkinda istatistiki analiz
yapiyor olsaydik tum insanlar nufus olurdu. Nufusun cogunlukla hangi
dagilimda oldugu bilinmez, biliniyor olsa da dagilimin parametreleri
