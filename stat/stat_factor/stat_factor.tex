...
sebeplerinden birisidir, alisveris sepeti analizi. Musterinin her
...
kendileri de ikisel olan iki yeni matris elde ettigimizde bir anlamda boyut
indirgemesi yapmis oluruz, yani sanki ana matrisi ``ozetleriz''. Iste bu
ozet, ozellikle carpilan ``baz'' matris, oge kumelerinin hangileri oldugu
hakkinda ipuclari iceriyor olabilir.
...
olmali / baz olusturmali, ve kolondaki degerlerde belli bir kalip / oruntu
(pattern) olmali. O zaman her baz kolonunda birbiriyle alakali olan ogeler
ayni anda 1 degeri tasiyor olacaktir.

Sonuca gore uzun sacli ve unlu olmak arasinda baglanti varmis, ayrica erkek
olmak ve unlu olmak arasinda da baglanti varmis :) Veriye gore boyle en
azindan.. Bu sonucu orijinal matrise bakarak ta kontrol edebiliriz.
...
seyreklik cok buyuk fark yaratiyor ki kategorik veriler gercek dunyada
cogunlukla seyrek olarak goruluyor. Eldeki 2000 tane mal cesidi icinden bir
sepette ancak 5-10 tane urun oluyor mesela, tum 2000 tane mali bir sepete
koymak mumkun degil.
...
Hava ile alakali bazi veriler bunlar; bu veriler tahmin (outlook), sicaklik
(temparature), nem (humidity), ruzgar (windy), disarida oyun oynayan var mi
(play). Mesela ilk satirda tahmin gunesli, isi sicak, nem yuksek, ruzgar
yok ve oyun oynayan yok. Bu sekilde bir suru satir. Biz bu veride bir kalip
olup olmadigina bakacagiz.
...
[1]'deki veriye uygularsak, sonuc soyle:
...
her turlu gereklilik bir yerler tikilabilir, bu normal. 2. sonuc FPGrowth
sonucunda var, guzel. 3. sonuc ta neredeyse ayni, sadece ek olarak
...
yaparken outlook=overcast elenince ana kalibi bulurduk. 4. sonuc ise cok
onemli bir kalip ve FPGrowth bunu tamamen kacirmis!
...
muhakkak ozgun bir dal yapisinda olmayabilir. 
...
uretebiliyor, ayrica 0.1 gibi degerler de oluyor. Biz bildigimiz \verb!.5!
sonrasi uzerini 1 yapmayi secmedik, belli bir esik degeri (threshold)
uzerinden yuvarlama yapiyoruz. Yani esik=0.2 ise 0.7 alta yuvarlanir ve 0
olur, 0.9 esik ustunde oldugu icin uste yuvarlanir 1 olur.
