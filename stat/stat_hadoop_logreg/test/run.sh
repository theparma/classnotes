...
cat /home/burak/Downloads/logistic-regression-sgd-mapreduce/train.data | ./train_mapper.py
#cat /home/burak/Downloads/logistic-regression-sgd-mapreduce/train.data | python read.py
