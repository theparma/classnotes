...
if len(sys.argv) == 1 or sys.argv[1] == 'tex':
    cmd = """
    pdftk \
    ./stat_00/stat_00.pdf ./stat_intro/stat_intro.pdf \
     ./stat_cov_corr/stat_cov_corr.pdf ./stat_summary/stat_summary.pdf \
    ...
    ./stat_regular/stat_regular.pdf ./stat_worldcup/stat_worldcup.pdf \
    ./stat_hadoop_patent/patent.pdf ./stat_hadoop_kmeans/kmeans.pdf \
    ./stat_hadoop_logreg/stat_hadoop_logreg.pdf \
    ./stat_multiout/stat_multout_reg.pdf ./stat_hadoop_AtA_qr/stat_AtA_qr.pdf \
