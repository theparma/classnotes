...
olasilik kutle fonksiyonu (probability mass function) 
...
O zaman $F_X(x)$'in turevi alinabildigi her $x$ noktasinda  $f_X(x) = F'_X(x)$
demektir. 
...
nokta arasinda entegral hesabi yapmamiz gereklidir. 
