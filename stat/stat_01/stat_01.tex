...
$X \ eqind \ Y$ eger $F_X(x) = F_Y(x)$, $\forall x$. Bu $X,Y$ birbirine
esit, birbirinin aynisi demek degildir. Bu degiskenler hakkindaki tum
olasiliksal islemler, sonuclar ayni olacak demektir. 
