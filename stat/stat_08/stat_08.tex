...
toplam haline donusur, boylece gittikce buyuyen bir sayi ile islem
yapilabilir, oteki turlu olasilik degeri oldugu icin 1'den kucuk sayilarin
surekli birbiri ile carpimi, nihai carpimi asiri kucultur, bu da
bilgisayarin numerik hesap sinirlarini zorlayabilir. $X$'i tum $x$'leri
iceren bir matrix olarak kabul edelim
...
ozyineli (iteratif) olarak gidip gelir. Tabii konunun cok fazla detayi var,
...
haricinde bu degere yaklasilir. 
...
for $i$ = $1$ to $N$ do
    ...
    O modele $N(x_i|\mu_m,\Sigma_m)$ (ya da onun Bernoulli karsiligi) $x_i$ i    
    urettir
end
\end{lstlisting}
