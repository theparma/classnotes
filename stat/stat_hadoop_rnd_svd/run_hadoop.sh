...
hadoop dfs -copyFromLocal A.dat hdfs:///user/

hadoop dfs -rmr hdfs:///user/Y.dat

python mrproj.py  hdfs:///user/A.dat --n=30 --file mrc.py --k=7 --output hdfs:///user/Y.dat --no-output -r hadoop
...
python mraq.py hdfs:///user/A.dat hdfs:///user/Q.dat --output hdfs:///user/BT.dat --no-output --file mrc.py -r hadoop --k=7 --n=30
