...
gorur. Kabaca bildiðimiz günlük bir gerçeðin matematiksel ispatýdýr da
...
deðiþkenler ya 1 ya da 0 deðeri taþýyacak, Yazý=1, Tura=0.

Buna göre, n tane deneyden sonra elimize gelmesi gereken yazý oraný þudur.

$$ \bar{X}_n = \frac{1}{n} \sum_{i=1}^n X_i  $$

Büyük sayýlar kanunu, $n$ büyüdükçe $\bar{X}_n$'in 1/2'ye yaklaþtýðýný
ispatlar, yani $E[X_i] = 1/2$ degerine. Burada ne soylendigine dikkat
edelim, $X_i$ dagilimi {\em ne olursa olsun}, yani ister Binom, ister
Gaussian olsun, {\em orneklem} uzerinden hesaplanan sayisal ortalamanin
(empirical mean) formulsel olasilik beklentisine yaklastigini soyluyoruz!
Istatistik ile olasilik teorisi arasindaki baglanti bu.
...
O zaman her $\epsilon > 0$ icin ve $n \rightarrow \infty $, $p(|\bar{X}_n -
\mu|) \rightarrow 0$. 
...
$\bar{X}_n$ de bir rasgele deðiþkendir, çünku $\bar{X}_n$ deðiþkeni her $X_i$
daðýlýmýyla alakali.

Ýspat devam etmek için, þapkalý $X_n$ daðýlýmýnýn beklentisini bulmamýz gerekiyor. 
...
$\bar{X}_n$ daðýlýmýnýn standart sapmasýný da bulalým. 
...
$n \rightarrow \infty$, $$ P(|\bar{X}_n-\mu| > \epsilon) \rightarrow 0 $$
...
n\epsilon^2$ de $P(|\bar{X}_n-\mu| > \epsilon)$'den buyuk olduguna gore,
