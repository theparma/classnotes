...
dagilim. Yani sey 2. $\exp$ icin gecerli. 
...
Bu parcalarin her birini bir $\exp$ onunde kullanabiliriz, ve ikinci $\exp$
ifadesinin 
...
\[ 
\frac{ 1}{(2\pi)^{p/2} \det(\Sigma/\Sigma_{22})^{1/2}} 
 \]
\[ 
\exp \bigg\{
-\frac{1 }{2} 
...
Hatirlarsak, $M/H = E-FH^{-1}G$, ve ve $E = \Sigma_{11},F=\Sigma_{12},..$ o
zaman 
