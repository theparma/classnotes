...
\includegraphics[height=6cm]{stat_intro_02.png}
...
\includegraphics[height=4cm]{stat_intro_04.png}
...
$X$ duz, $Uniform(a,b)$ olarak dagilmis deriz, ve bu $X \sim
...
Diyelim ki bir bankadaki bekleme zamani ortalama 10 dakika ve ustel olarak
...
Kýsmi (Marginal) Dagilimlar 

Surekli rasgele degiskenler icin kýsmi yogunluk 
...
ust limit te tanimlamak zorundadir. Cunku kýsmi yogunluk icin bir veya
...
tekniklerle kýsmi olan, kosullu dagilimlari, vs. hesaplamak mumkundur.
