...
Diyelim ki bir $A$ matrisinin, ki $A \in \mathbb{R}^{n \times n}$, ozdegerleri $\lambda_1,...,\lambda_n$ ve 
ozvektorleri $v_1,..,v_n$ olarak verilmis. Bu demektir ki her $i=1,..,n$ 
icin $Av_i = \lambda_i v_i$. Farzedelim ki bu matrisin tum ozvektorleri bir 
``ozbaz (eigenbasis)'' olusturuyor ve bu baz ile $\mathbb{R}^n$'deki
herhangi bir vektoru temsil edebiliyoruz. Hatirlayalim eger tekrar
eden ozdeger yok ise (hepsi degisik), normalize edilmis $v_i$ vektorleri 
ortonormal bir set olustururlar, $||v||=1,v_i^Tv_i=1,v_j^Tv_i=0$ demektir.

Diyelim ki $|\lambda_1| > |\lambda_2| > .. >
|\lambda_n| $, bu yazida $\lambda_1$'e  baskin 
(dominant) ozdeger diyecegiz. Simdi Herhangi bir $v_0 \in \mathbb{R}^n$'i
alalim.  Usttekiler isiginda $\mu_1,..,\mu_n$ olarak oyle katsayilar olmalidir ki 
...
Peki ozdegerin kendisini nasil buluruz? Rayleigh Bolumu (Rayleigh Quotient) 
formulunu kullanabiliriz. Bu formul, eger $x$ bir ozvektor ise
...
$\lambda$ bir tek sayi olduguna gore sag taraftan $x^Tx$'i alip, solda bolum
yapabiliriz, ve Rayleigh formulune erisiriz.

$$ x^TAx / x^Tx = \lambda $$

1. ozdegeri hesaplayalim o zaman,
...
En buyuk ozdegeri bulmanin yolunu gorduk. Diger ozvektorleri nasil buluruz?
Bunun yontemlerinden birisi en buyuk ozdeger $\lambda_1$'i bulduktan sonra
onu bir islem sonrasi en kucuk haline getirmek, ve Ust Metotu tekrar
kullanarak (artik en buyuk olan) $\lambda_2$'yi bulmak. $\lambda_1$'i en
kucuk haline getirmek, ozdeger/vektoru ana matris $A$'dan cikartmak, onu
``deflasyon islemine tabi tutmak'' (deflation) olarak
biliniyor. Cikartacagimiz deger  $\lambda_1u_1u_1^T$ olacak. Ispati
soyle gosterelim (normalize edilmis $v_i$ ozvektorleri simdi $u_i$ olarak
gosteriyoruz), 
...
Yani $(A-\lambda_1u_1u_1^T)$'nin ozvektorleri $A$ ile aynidir, tek farki en
buyuk olani 0 haline gelmistir, ama $j \ne 1$ icin, yani diger tum
ozvektorleri aynidir. O zaman deflasyon isleminden sonra ele gecen yeni
matris uzerinde Ust Metotu tekrar kullanirsak artik en buyuk olan $u_2$'yi
buluruz, sonra deflasyonu tekrarlariz, bir daha Ust Metot isletiriz, bu
boyle devam eder. 
...
Rayleigh Bolumu ile ikinci ozdegeri bulalim,
...
[3] \url{http://www.robots.ox.ac.uk/~sjrob/Teaching/EngComp/ecl4.pdf}
