...
geciyordu. Bagimsizligin tanimi mesela $y_2$'nin $y_1$'in ``katý''
olmamasý, yani bir cozumu tamsayi bir sabitle carpinca digerini elde
...
Bu derste cevaplandiracagimiz soru þu: Niye? 
...
``tüm'' cozumlerin onlar oldugunu daha zor olan 2. sorunun cevabi
belirleyecek.

Soru 2: Niye tüm cozumler bunlardýr?
...
{\em çarpý} y'' diye okumaya meyilli oluyor, bu dogru degil. Boyle bir ima
...
bir yan yola girerek, cevabi ``baslangic deger problemini cozme'' açýsýndan
