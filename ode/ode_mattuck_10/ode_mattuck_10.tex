...
Bu dersin konusu salýnýmlar (oscillations), ki bu kavram gunluk hayatta
surekli karþýlaþýlan ve onemli bir kavramdir. Bizim onceden gordugumuz
salýnýmlar karakteristik denklem $r^2 + br + k = 0$'in kompleks kokleri ile
...
\[ y = c_1 cos(\omega_0 t) + c_2 isin (\omega_0 t) \]
