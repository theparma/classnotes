...
Simdiye kadar esitligin sag tarafi sıfır olmustu, artik orada bir fonksiyon
...
Cozum $y(x)$ ise cevap (response) olarak nitelenir, çıktı (output) kelimesi
de kullanilir. 
...
0$ 
denklemi cozum icin onemli. Sıfıra esit olan denkleme de farkli isimler
...
bu sistemde daha once sag taraf sıfırdi. Simdi sıfır yerine olan $f(t)$
...
\begin{tabular}{l|l|l}
\hline
Karakteristik denklemin kokleri &  Cozumler & Stabilite şartı  \\ 
\hline
