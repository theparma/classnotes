...
Laplace Transformunu ile burum islemi arasindaki baglantiyi gorduk. Burum
cok onemli bir islemdir, ama onu kullanan pek cok kisi onu Laplace
...
$f(t)$: atim hizi (rate), $t$ sene. Atim hizi iki zaman noktasini
dusunursek, $t_i,t_{i+1}$ arasinda uretilen radyoaktif atigin $\approx
f(t_i) \cdot \Delta t$ 
anlaminda. 

\includegraphics[height=2cm]{21_3.png}

Zaman kuculdukce ustteki hesap iyilesiyor. 

Problemim, $t=0$'dan baslarsam $t$ aninda ne kadar radyoaktif atik
biriktiginin hesabi. 

Bu hesabi zorlastiran radyoaktif maddelerin ayni anda curuyor
olmasidir. Yani bir yandan atik uretiliyor, bir yandan bu atiklar bir
sekilde radyoaktif ozelliklerini kaybediyorlar. Yani yaptigimiz hesap
uretilen madde obeklerinin, parcalarinin birikintide ``ne kadar
bekledigini'' de hesaba katmali \textbf{ki} onun curumesini de
bir yandan hesaplayabilelim.
