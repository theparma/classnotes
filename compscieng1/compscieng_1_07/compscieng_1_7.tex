...
Bugün pozitif kesinlik (positive definite) günü. Simdiye kadar lineer
...
2. Tum ust sol determinantlar (upper left determinants)  $>$ 0
...
$N \times M$ ve $M \times K$ carpimi $N \times K$ boyutlarinda bir matris
cikartir. Elde edecegimiz $1 \times 1$ ise, bu tek bir sayidir. Tek sayinin
bilesenleri nedir? Carpimi cebirsel olarak takip edersek
...
Ilginc bir durum pozitif kesinligin tam sýnýrýndaki durumdur. Matematikte
bu tür sýnýr sartlarý anlamak butunu kavramakta faydali oluyor. Mesela
...
Bu matrise bakalim, ikinci kolon birincisinin ``katý'' oldugu icin hemen
...
determinantlari $\ge 0$, ve sebep olduklarý $f(x) \ge 0$, yani enerjileri
$\ge 0$. 
