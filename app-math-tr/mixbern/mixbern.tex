...
\begin{document}
Dagilim Karisimlari ve Takip Edilmedenk Kumeleme (Unsupervised Clustering)
...
cevrit goruntuleri cikacaktir, yani kumeleme basariyla isletilmistir.  Cok
...
Mixture Of Gaussians, \verb!http://www-clmc.usc.edu/~adsouza/notes/mix_gauss.pdf!
...
[7] \verb!http://ascratchpad.blogspot.de/2010/01/porting-code-from-matlab-octave-to.html!

[8] \verb!http://www.scipy.org/NumPy_for_Matlab_Users/!

[9] \verb!http://mathesaurus.sourceforge.net/matlab-numpy.html!
