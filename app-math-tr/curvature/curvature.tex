...
Simdi $y'$'in turevini bir daha alalim. Yukaridaki $y'$ formulunde en sag taraf
bir bolme islemi icerdigi icin burada Calculus'un Bolumler Kuralini (Quotient
Rule) uygulamamiz lazim. Bu kural soyle gosterilir:

\[ \frac{d}{dx}\bigg(\frac{u}{v}\bigg) = \frac{\frac{v du}{dx} - \frac{u dv}{dx}}{v^2} \]
...
\[ \kappa = \frac{- \frac{F_y^2F_{xx} - 2F_{xy}F_xF_y +
    F_x^2F_{yy}}{F_y^3}}
{(1+f'^2)^{3/2}} 
\]  
...
\[ 
\kappa = \frac{- \frac{F_y^2F_{xx} - 2F_{xy}F_xF_y + F_x^2F_{yy}}{F_y^3}}
{(F_y^2 + F_x^2)^{3/2}F_y^{-3}}
 \]
