...
\inputminted{common-lisp}{ortak.lisp}

\inputminted{common-lisp}{kat-kat-ara.lisp}

\inputminted{common-lisp}{kat-engelli-da.lisp}

\inputminted{common-lisp}{iki-yonlu-arama.lisp}

\inputminted{common-lisp}{git-gide-derin-kka.lisp}

\inputminted{common-lisp}{fiyati-sabit-arama.lisp}

\inputminted{common-lisp}{a-yildiz-arama.lisp}
...
\inputminted{common-lisp}{dama-alg.lisp}

\inputminted{common-lisp}{dama-deger.lisp}

\inputminted{common-lisp}{dama-oyna.lisp}

\inputminted{common-lisp}{dama-temel.lisp}

\inputminted{common-lisp}{dama-test.lisp}
