...
$p$ log sansinin monotonik bir fonksiyonu ve log sans $p$'nin monotonik bir
fonksiyonu. Yani ustteki esitligin lineer bir fonksiyon olan sag tarafi ne
kadar buyurse olasilik, yani log sans o kadar buyuyecektir. Bu buyume
durumu mesela $\beta_j$ katsayisiniz veri analizi baglaminda yorumlanabilir
hale getirir. 
