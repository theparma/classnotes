...
$$ 
M_{123...n+1} (BASLA, BITIS) =  \sum_{y_1,...,y_n} 
\exp [
...
dinamik programlama kategorisine girer dedik, ustteki algoritma aslinda bir
matris carpimi sadece. Daha genel olarak ustteki algoritma ileri-geri
(forward-backward) algoritmasinin bir turevi, bu algoritmalar bildigimiz
...
$$ 
y|x;w) = \frac{\exp \sum_j w_j F_j(x,y)  }{Z(x;w)}
$$
...
(expectation) tanimi gibi. Tum $F_j$ degerlerini o degerlerin olasiliklari
ile carpip toplarsak bir beklenti elde etmez miyiz? Evet. O zaman 
