...
degisik bri $g$ fonksiyonuna sahip oluyorum. 
...
Bize gereken belli $y_{i-1},y_i$ kombinasyonu icin bir $g$ degeri dondurulmesi, ve bu
sonucu bir yerde depolayabilmek.

Gereken yapi basit bir matris olabilir. Diyelim ki $m$ farkli $y$ degeri
var ise, $m^2$ hucresi olan bir matris isimizi gorur.
