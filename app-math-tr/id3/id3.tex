...
Zeki arama konusunda gördüðümüz gibi, arama algoritmasýna tahmin yeteneðini
kazandirdigimizda problem sonucuna ulaþým hýzýmýzý arttýrmýþtýk. Tahmin
...
# lisp verisi ile fark kimlik kolon yok, ve ondan sonraki kolon
# sona atildi olmasi cunku etiketlerin orada olmasi lazim
dataSet = [
...
'FIYAT','YAGMUR', 'RESERVASYON','YEMEKTURU','BEKLEMESURESI']
...
\inputminted{common-lisp}{id3.lisp}
