...
kýsýtlý bir enküçültme/enbüyütme probleminin çözümü olduðun
görüyoruz. Kýsýtlý derken, $x*x$ (x vektör devriði çarpý $x$, yani
x'in uzunluðu) çarpýmýný 1'e kýsýtlý tutmaktan bahsediyorum. Böylece
enbüyütme problemimizin sonsuzluða gitmesini engellemiþ oluyoruz. Kývrýk
ters v iþaretine benzeyen sembol, genelde özdeðerler için
kullanýlýr. Yýldýz iþareti (*) sanal sayýlar uzayýnda, devrik yapmak
demektir. Gerçek sayýlar uzayýnda olsaydýk, o zaman T iþaretini
kullanabilirdik. (T transpose kelimesinden gelir).
