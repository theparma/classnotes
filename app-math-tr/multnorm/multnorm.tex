...
yok, yani bu sistem artýk belirtilmiþ (overdetermined) degil, yani en az
kareler degil direk lineer sistem cozumu yapiyoruz. Her neyse, bu durumda
her standart lineer cebir kutuphanesinde mevcut bir cagri ile $L^{-1}y$
hesabini yapabiliriz, mesela \verb!solve! ile, ve bu cagrilar perde arkasinda
ters alma isleminden kacinarak bir suru optimizasyon yaparak sonuca
erismektedirler. Ustune ustluk $L$ durumunda bu cok daha hizli olacaktir,
cunku $L$ alt-ucgensel oldugu icin cozum geriye deger koymak (back
substitution) ile aninda bulunabilir. Geriye deger koymayi hatirlarsak,
mesela
...
Simdi Cholesky ve \verb!solve! uzerinden
