...
\[ \int \frac{1}{p(a-bp)}dp = \int dt \]

\[ 
\frac{1}{a} \int \frac{1}{p} dp - \frac{1}{a} \int \frac{-b}{a-bp} dp =
\int dt
\]

\[ \frac{1}{a} ln|p| = \frac{1}{a}ln|a-bp| = t+c_1 \]

\[ ln \bigg| \frac{p}{a-bp} \bigg| = at + c_2 \]

\[ \frac{p}{a-bp} = c_3e^{at} \]

\[ p(t) = \frac{ ac_3 a^{at}}{bc_3e^{at} + 1} = \frac{ac_3e^{at}}{bc_3 + e^{-at}} \]
...
Bu ikinci modele, lojistik modeli ismi veriliyor. Lojistik bildiðimiz gibi,
mallarý bir yerden bir yere ulaþtýrmak, kaynak idaresi gibi anlamlar
çaðrýþtýrýyor, zaten ikinci denklemin içindeki faktörlerden biri de, artýk,
kaynaklara olan eriþimin oluþturduðu yarýþma durumudur.

Örnek 2

1790 yýlýndaki 3.93 milyonluk nüfusu temel alarak, ve 1840 yýlýnda 17.07
milyon ve 1890 yýlýnda 62.95 milyonluk nüfusu varsayarak, $t$'ye göre olan
bir nüfus fonksiyonu bul.

Çözüm: $t=0$ 1790 senesi olduðuna göre, $p_0 = 3.93$ demektir. Þimdi a ve b
parametrelerini bulmamýz lazým. $p(50) = 17.07, p(100) = 62.95$ oluyor.

\[ 17.07 = \frac{3.93a}{3.93b + (a-3.93b)e^{-50a}} \]

\[ 62.95 =  \frac{3.93a}{3.93b + (a-3.93b)e^{-100a}} \]

Ýki bilinmeyenli ve doðrusal olmayan bir denklem var elimizde. Genelde
böyle bir sistemi çözmek için yaklaþýksal (approximate) bir yöntem
kullanmamýz gerekecekti, Newton metodu gibi. Fakat, t1 ve t2 zamanlarýnda
olan deðerleri bildiðimiz için, çözüm þöyle olacak.

\[ 3.93b = \frac{3.93-17.07e^{-50a}}{17.07 (1-e^{-50a})} \]

Bu denklemi 2 üstteki denkleme koyduðumuz zaman, bir takým cebir
iþlemlerinden sonra, elimize þu deðerler çýkacak. a = 0.0304667 ve b =
0.0001214. Yani, elimizdeki veriler icin olan lojistik model þöyle olacak.

\[ p(t) = \frac{0.11977340}{(0.0004771 + 0.0299896) - e^{-0.0304667}} \]

Bu sonucu verilerden kontrol etmeyi size býrakýyorum.
