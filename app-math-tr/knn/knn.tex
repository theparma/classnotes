...
imajlar (duzlestirilince $M \cdot N$ boyutunda), ve onlarin icindeki
resimlerin kime ait oldugu etiket bilgisi olabilir. kNN bu tur multimedya,
cok boyutlu veri ortaminda basarili sekilde calisabilmektedir. Ayrica en
yakin k komsunun icerigi tarifsel bilgi cikarimi (knowledge extraction)
amaciyla da kullanilabilir [2].
...
dondurulen degiskenlerdir, sozde programdaki $P^{in},P^{out}$'un
karsiligidirlar.
...
yapisi icine \verb!min_so_far! olarak saklaniyor, sozde programdaki
$D_{sofar}$.
