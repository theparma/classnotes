...
etiketi ne ise, o etiket yeni noktanin etiketi olarak kabul edilir. Mesela
elde \verb!1! kategorisi altinda \verb![2 2]!, \verb!2! kategorisi altinda
\verb![5 5]! var ise, yeni nokta \verb![3, 3]! icin yakinlik acisindan
\verb![2 2]! bulunmali ve etiket olarak \verb!1! sonucu dondurulmelidir.
...
zorlasabilir. Mesela goruntu tanimada veri \verb!M x N! boyutundaki dijital
imajlar (genellikle duzlestirilince $M \cdot N$ boyutunda) egitim verisi,
resimlerin kime ait oldugu etiket bilgisi olabilir. kNN bu tur multimedya,
ve pek cok degisik cok boyutlu ortamda basarili sekilde
calisabilmektedir. En yakin k komsunun icerigi bilgi cikarim (knowledge
extraction) amaciyla da kullanilabilir [2].
...
teker teker hesaplayip en yakin k taneyi icinden secmek bir yontemdir.. Bu
basit algoritmanin yuku $O(N)$'dir. Eger tek bir nokta ariyor olsaydik, bu
...
[2] Alpaydin, {\em Introduction to Machine Learning}
