...
operasyonunda yogun bir sekilde kullanildi. Elde sýnýrlý miktarda ucak,
kargo kapasitesi vardi ve diger bazi kýsýtlamalar (constraints) da goz
...
tasidiklari yuku maksimize etmek zorundaydilar. Diger kýsýtlamalar
...
\inputminted[fontsize=\footnotesize]{python}{berlin.py}
...
\url{projects.scipy.org/scipy/attachment/ticket/1252/lp.py}
