...
verinin tamami), o baz alinarak $p(h^0|v^0)$ hesaplanir (ki bu ustteki
sigmoid, ve onun uzerinden $h^0$ orneklemi toplanir yani). Sonra $h^0$ baz
alinir ve $x^1$, bu boyle devam eder. Literaturde su sekildeki resim bolca
gorulebilir,
