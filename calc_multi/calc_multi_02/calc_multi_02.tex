...
Aradaki açý $\theta$ ise ve ucgen dik ise, o zaman bu yansima 
...
Muhakkak sarkacin $y$ ekseni ile olusturdugu bir açý $\theta$ uzerinden bir
...
Devam edelim: Madem açýlarin cos degerlerini bulmayi biliyoruz, belki oyle
bir diger açý bulmaliyiz ki o açýnin cos degeri bizim aradigimiz açýnin sin
degeri olsun, cunku alan icin sin gerekiyor, ama hesaplayabildigimiz cos. 

Birbirini tamamlayici açýlar (complemantary angles) kavramini biliyoruz
herhalde. 

\includegraphics[height=3cm]{2_6.png}

Diyelim ki elimizde $\vec{A}$ var, onu $90^o$ cevirip ustteki hale getiriyoruz,
yeni vektore $\vec{A'}$ diyelim. O vektor ile $\vec{B}$ arasindaki açýya da
$\theta'$ diyelim. 
...
Simdi bu islemi alan hesabinda kullanalim. 

\includegraphics[height=3cm]{2_10.png}

Ve $\vec{A} \times \vec{B}$ ikisinin ciktigi noktadan, bu iki vektore de
dik olan 3. bir vektoru yaratir. Peki $\vec{A} \times \vec{B}$ hesabinin
hangi yonde bir vektor yaratacagini nereden bilecegiz? Sag el kuralini
kullanarak.
