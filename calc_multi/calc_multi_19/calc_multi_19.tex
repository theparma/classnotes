...
$\vec{F} \cdot \vec{T}$'yi tek sayisal (scalar) bir nicelik olarak
gorebiliriz, ki bu tek sayi kuvvetin teget yonunde olan etkisi, kuvveti o
yone ``yansitinca (projection)'' ele gecen deger. Sonra bu yansimasi alip
...
Bu durumda her iki vektor ayni yone isaret ediyor. 
