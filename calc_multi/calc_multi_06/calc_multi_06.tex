...
\[ \vec{r} = 2cos^2(t) \hat{i} + sin^2(t) \hat{j}  \]
...
elde ederiz, cunku trigonometriden $cos^2(t) + sin^2(t) = 1$ oldugunu
...
Su kod olanlari animasyonlu olarak gosterecektir. 

\lstinputlisting[language=Python]{1i3.py}
...
\[ \vec{v} = -4sin(t)\hat{i} + 4cos(t)\hat{j} + 3\hat{k} \]

\[ |v| = \sqrt{16sin^2t + 16cos^2t  + 9} = 
