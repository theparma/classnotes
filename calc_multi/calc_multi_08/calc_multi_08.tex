...
\[ \underbrace{\frac{x^2}{a^2} +  \frac{y^2}{b^2}}_{w}
 + \frac{z^2}{c^2}  = 1  \]
...
\[ w^2 = cos^2\phi = \frac{x^2}{a^2} +  \frac{y^2}{b^2}  \]

Esitligin en sagina bakarsak, yine kareler toplami goruyoruz. Ama bu sefer
karelerin toplami 1 degil, $cos^2\phi$ vermis. Problem degil, karelerin
icine bir $cos\ \phi$ biz sokarsak, o zaman sonucta istedigimiz bir
ekstra $cos^2\phi$ kendiliginden gelecek. 

\[ \frac{x}{a} = cos\phi \ cos\theta  \]

\[ \frac{y}{b} = cos\phi \ sin\theta  \]
