...
Bu problemi modellerken zihnimizde olusan, istifade ettigimiz þekil þu:

\includegraphics[height=2cm]{cycloid-lines.png}

çünkü vektor toplaminin geometrik olarak nasil isledigini biliyoruz, ve
...
y-ekseniyle olusturdugu açý. Boylece onun uzerinden ve $a$ ile uc vektoru
